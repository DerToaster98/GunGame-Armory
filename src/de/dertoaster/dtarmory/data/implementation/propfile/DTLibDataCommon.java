...
import de.dertoaster.dtarmory.data.IDTArmoryItemDataBase;
import de.dertoaster.dtlib.properties.IConfigurable;
import de.dertoaster.dtlib.properties.datatypes.PropertyDataTypes;

public abstract class DTLibDataCommon implements IDTArmoryItemDataBase, IConfigurable {
	...
	public DTLibDataCommon() {
		...
		this.registerAdditional(this.entries);
	}
	
	protected abstract void registerAdditional(Map<String, PropertyEntry<?>> entries);
